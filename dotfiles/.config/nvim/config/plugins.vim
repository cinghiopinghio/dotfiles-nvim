...
if has('nvim-0.5')
    ...
    " " avoid problems with the AutoPairs plugin
...
command! -bang Files
            ...
            \ 'source': 'find . -type d -name ".ipynb_checkpoints" -prune -o -type d -name "__pycache__" -prune -o -type d -name ".ipynb_checkpoints" -prune -o -type f -o -type l'
            \ }, <bang>0))
